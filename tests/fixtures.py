...
from azure_tools.storage import *
...
def patched_creds_connector():
    ...
    def connector_factory(*args, **kwargs):
        with patch("azure_tools.storage.DefaultAzureCredential", return_value="mock-cred"):
...
class MockConnector:
    ...
    def is_azure_path(self, path: str) -> bool:
        with patch("azure_tools.storage.DefaultAzureCredential", return_value="mock-cred"):
            with patch("azure_tools.storage.BlobServiceClient"):
                con = Connector()
